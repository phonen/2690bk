...
$(function() {
	...
	$('.WeChat-code').click(function() {
		if($('#WeChat-code-img').attr('src')==''){
			$('#WeChat-code-img').attr('src',$('#WeChat-code-img').attr('data'));
		}
	...
	$('.side-bar-item').mouseenter(function() {
		$(this).css('animation','mymove 5s infinite');
	})
	$('.side-bar-item').mouseleave(function() {
		$(this).css('animation','mymove2 5s infinite');
	})
})