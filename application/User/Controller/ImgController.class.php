...
define('PNG_QR_RECT', serialize(array(35,560,193,719)));//二维码
...
class ImgController extends HomebaseController {
    ...
    public function homemadepic(){
    	...
    	/*
    	//判断是否有数据
    	if($dtitle && $pic && $url && $price && $coupri && $intro){
    		header("Content-type: image/jpg");
    		$this->generatePic($dtitle,$pic,$url,$price,$coupri,$intro);
    	}
    	*/
    }
